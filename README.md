...
> [!NOTE]
> This repository is a research fork of the Exgentic snapshot used by
> [AgentStream in Sico](https://github.com/microsoft/Sico). It contains local
> ACE and benchmark experiments; it is not an official Exgentic release.
> See [team setup](docs/TEAM_SETUP.md) and the
> [2026-09-24 change log](docs/CHANGELOG_2026-09-24.md) before running experiments.
